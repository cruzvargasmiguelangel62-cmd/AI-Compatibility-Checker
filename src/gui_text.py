...
TRANSLATIONS = {
    "es": {
        "UI_TEXT": {
            ...
            "ollama_api_online": "Ollama API: Activo",
            "ollama_api_offline": "Ollama API: Inactivo",
            "download_installed": "✓ Instalado",
            "download_retry": "Reintentar",
            "download_in_progress": "Descargando...",
            "download_success": "¡Instalado!",
            "disk_label": "Disco",
            "disk_subtitle": "{free_disk} GB libres",
            "disk_warning": "⚠️ Falta disco: se requieren {disk_needed:.1f} GB pero solo quedan {free_disk:.1f} GB libres",
            "settings_title": "SIMULACIÓN LOCAL ⚙",
            "quant_label": "Cuantización",
            "context_label": "Contexto (KV Cache)",
            "copy_specs_btn": "📋 Copiar Especificaciones",
            "ram_usable_label": "Usable ({installed} GB física)",
            "last_scan_label": "Último escaneo: hace {minutes} min",
            "last_scan_never": "Sin escaneo previo",
            "btn_run": "⚡ Ejecutar",
            "btn_download": "📥 Descargar",
            "btn_copy": "📋 Copiar",
            "btn_guide": "💡 Guía SD/Flux",
    ...
    "en": {
        "UI_TEXT": {
            ...
            "ollama_api_online": "Ollama API: Online",
            "ollama_api_offline": "Ollama API: Offline",
            "download_installed": "✓ Installed",
            "download_retry": "Retry",
            "download_in_progress": "Downloading...",
            "download_success": "Installed!",
            "disk_label": "Disk",
            "disk_subtitle": "{free_disk} GB free",
            "disk_warning": "⚠️ Low disk: {disk_needed:.1f} GB required but only {free_disk:.1f} GB free",
            "settings_title": "LOCAL SIMULATION ⚙",
            "quant_label": "Quantization",
            "context_label": "Context (KV Cache)",
            "copy_specs_btn": "📋 Copy Specifications",
            "ram_usable_label": "Usable ({installed} GB physical)",
            "last_scan_label": "Last scan: {minutes} min ago",
            "last_scan_never": "No previous scan",
            "btn_run": "⚡ Run",
            "btn_download": "📥 Download",
            "btn_copy": "📋 Copy",
            "btn_guide": "💡 SD/Flux Guide",
